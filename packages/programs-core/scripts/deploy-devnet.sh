...
printf '  Next: the mock USDC mint (D19, H7hBn9A1MDuKLhLji26bkRv5P3zMnp9jQmxNo76wsGyK)\n'
printf '  must exist on devnet before markets can be funded — that needs its\n'
printf '  mint authority, which is not in this repo. Then seed a market and\n'
printf '  point the demo at chain 901.\n\n'
